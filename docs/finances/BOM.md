...
| **Logic Power** | **LM2596 Buck Converter** - Steps the 24V rail down to 5V for logic; use a **dedicated** buck for **Raspberry Pi 4** (`5V_PI`, ≥3A capable). Nucleo/STM32 **3.3V core** comes from the dev board regulator, not the LM2596 output directly. | Sayal / Amazon | ~$5.00 | Search: LM2596 Module |
...
| **PC ↔ STM32 debug** | **USB A to Micro-B cable** - Connects the PC to the **Nucleo-F401RE ST-Link** port (flash, debug, USB serial). Many kits use blue molded plugs; **USB 2.0 is fine** — match **Micro-B** to this board. | Amazon / electronics | ~$5–10 | Search: USB A to Micro B cable |
...
| **PC ↔ STM32 debug** | **USB A to Micro-B cable** - Same as production BOM: PC to Nucleo ST-Link for PlatformIO upload and serial monitor. | Amazon / electronics | ~$5–10 | Search: USB A to Micro B cable |
| **Logic Power** | **LM2596 Buck Converter** - Mandatory for breadboard testing so you don't fry your STM32/Pi with 24V; Pi 4 buck should handle **≥3A** peaks if powering the Pi from it. | Sayal / Amazon | ~$5.00 | Search: LM2596 Module |
